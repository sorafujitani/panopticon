...
依頼と scout の事実に基づいて実装してください。既存の main worktree、別 workspace、別 agent の変更を触らないでください。破壊的な統合、push、merge、commit は自動で行わないでください。妥当な対象テストを実行し、変更内容とテストを JSON に記録してください。
